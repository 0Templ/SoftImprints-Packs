...
The block textures in this pack are derived from the **Faithful Resource Pack (64x)**
and have been modified for use with the Soft Imprints mod.
...
files, icon) is licensed separately under MIT — see `LICENSE-IMPRINTS`.
